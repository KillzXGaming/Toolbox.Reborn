namespace STLibrary.Forms
{
    partial class ExportModelSettings
    {
        ...
        {
            this.exportTexturesChkBox = new STLibrary.Forms.STCheckBox();
            this.stButton1 = new STLibrary.Forms.STButton();
            this.stButton2 = new STLibrary.Forms.STButton();
            this.chkFlipUvsVertical = new STLibrary.Forms.STCheckBox();
            this.chkVertexColors = new STLibrary.Forms.STCheckBox();
            this.chkExportRiggedBonesOnly = new STLibrary.Forms.STCheckBox();
            this.chkApplyUVTransforms = new STLibrary.Forms.STCheckBox();
            this.chkTextureChannelComps = new STLibrary.Forms.STCheckBox();
