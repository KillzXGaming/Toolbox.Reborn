        ...
        public override void RenderScene()
        {
            ...
            if (ActiveTextureMap != null)
            {
                ...
                if (tex != null)
                {
                    ...
                    GL.TexParameter(TextureTarget.Texture2D, TextureParameterName.TextureWrapS, (float)Toolbox.Core.OpenGLHelper.WrapMode[ActiveTextureMap.WrapU]);
                    GL.TexParameter(TextureTarget.Texture2D, TextureParameterName.TextureWrapT, (float)Toolbox.Core.OpenGLHelper.WrapMode[ActiveTextureMap.WrapV]);
                    GL.TexParameter(TextureTarget.Texture2D, TextureParameterName.TextureMinFilter, (int)Toolbox.Core.OpenGLHelper.MinFilter[ActiveTextureMap.MinFilter]);
                    GL.TexParameter(TextureTarget.Texture2D, TextureParameterName.TextureMagFilter, (int)Toolbox.Core.OpenGLHelper.MagFilter[ActiveTextureMap.MagFilter]);
