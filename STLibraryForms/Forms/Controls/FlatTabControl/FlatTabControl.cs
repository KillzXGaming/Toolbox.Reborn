	...
	public class FlatTabControl : System.Windows.Forms.TabControl
	{
		...
		internal void DrawControl(Graphics g)
		{
			...
			if (this.SelectedTab != null)
			{
                ...
                tabPage.BackColor = STLibrary.Forms.FormThemes.BaseTheme.TabPageActive;
        ...
        private void UpdateTabColor()
        {
            ...
            {
                tpCheck.BackColor = STLibrary.Forms.FormThemes.BaseTheme.TabPageInactive;
                tpCheck.ForeColor = STLibrary.Forms.FormThemes.BaseTheme.DisabledItemColor;
            }

            if (SelectedTab != null)
            {
                SelectedTab.BackColor = STLibrary.Forms.FormThemes.BaseTheme.TabPageActive;
                SelectedTab.ForeColor = STLibrary.Forms.FormThemes.BaseTheme.TextForeColor;
            }
		...
		[Browsable(true)]
		new internal Color myBackColor
		{
