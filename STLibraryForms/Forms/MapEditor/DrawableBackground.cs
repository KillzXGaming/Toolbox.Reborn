...
namespace STLibrary.Forms.MapEditor
{
    public class DrawableBackground : AbstractGlDrawable
    {
        ...
        public override void Draw(GL_ControlModern control, Pass pass)
        {
            ...
            Vector3 topColor = ColorUtility.ToVector3(Runtime.BackgroundSettings.backgroundGradientTop);
            Vector3 bottomColor = ColorUtility.ToVector3(Runtime.BackgroundSettings.backgroundGradientBottom);
        ...
        public override void Draw(GL_ControlLegacy control, Pass pass)
        {
            ...
            GL.Color3(Runtime.BackgroundSettings.backgroundGradientTop);
            GL.Vertex3(1, 1, 0.99998);
            GL.Vertex3(-1, 1, 0.99998);
            GL.Color3(Runtime.BackgroundSettings.backgroundGradientBottom);
            GL.Vertex3(1, -1, 0.99998);
            GL.Vertex3(-1, -1, 0.99998);
            GL.End();
