...
namespace Toolbox.Winforms
{
    public partial class ImageEditorBase : UserControl
    {
        ...
        public ImageEditorBase()
        {
            ...
            foreach (var type in Enum.GetValues(typeof(Runtime.ImageEditor.PictureBoxBG)))
                imageBGComboBox.Items.Add(type);

            imageBGComboBox.SelectedItem = Runtime.ImageEditor.pictureBoxStyle;
        ...
        {
            switch (Runtime.ImageEditor.pictureBoxStyle)
            {
        ...
        private void reEncodeToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                ActiveTexture.Platform.OutputFormat = encodingEditor.Format;
        ...
        private TexFormat FormatToChange = TexFormat.RGBA8_UNORM;
        ...
        {
            if (ActiveTexture.ArrayCount % 6 != 0)
                return;
