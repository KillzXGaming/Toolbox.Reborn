...
namespace Toolbox.Winforms
{
    public partial class ImageProgramSettings : STForm
    {
        ...
        public void LoadImage(STGenericTexture texture)
        {
            ...
            textureImageFormatCB.SelectedItem = texture.Platform.OutputFormat;
        }

        public TexFormat GetSelectedImageFormat() {
            return (TexFormat)textureImageFormatCB.SelectedItem;
        }
