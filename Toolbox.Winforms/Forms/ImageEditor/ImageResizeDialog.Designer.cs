namespace Toolbox.Winforms
{
    partial class ImageResizeDialog
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.btnOk = new STLibrary.Forms.STButton();
            this.btnCancel = new STLibrary.Forms.STButton();
            this.widthUD = new STLibrary.Forms.NumericUpDownUint();
            this.chkKeepAspectRatio = new STLibrary.Forms.STCheckBox();
            this.resampleCB = new STLibrary.Forms.STComboBox();
            ...
            this.heightUD = new STLibrary.Forms.NumericUpDownUint();
        ...
        private STLibrary.Forms.NumericUpDownUint heightUD;
        private STLibrary.Forms.STLabel stLabel3;
        private STLibrary.Forms.STLabel stLabel2;
        private STLibrary.Forms.STLabel stLabel1;
        private STLibrary.Forms.STComboBox resampleCB;
        private STLibrary.Forms.STCheckBox chkKeepAspectRatio;
        private STLibrary.Forms.NumericUpDownUint widthUD;
        private STLibrary.Forms.STButton btnCancel;
        private STLibrary.Forms.STButton btnOk;
    }
}