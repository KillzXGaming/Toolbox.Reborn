namespace Toolbox.Winforms
{
    partial class ImageEditorBase
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.noteifcationLbl = new STLibrary.Forms.STLabel();
            this.stPanel5 = new STLibrary.Forms.STPanel();
            this.bottomLabel = new STLibrary.Forms.STLabel();
            this.pictureBoxCustom1 = new STLibrary.Forms.PictureBoxCustom();
            this.stContextMenuStrip2 = new STLibrary.Forms.STContextMenuStrip(this.components);
            this.copyImageToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
            this.stPanel3 = new STLibrary.Forms.STPanel();
            this.alphaBtn = new STLibrary.Forms.STButton();
            this.editBtn = new STLibrary.Forms.STButton();
            this.saveBtn = new STLibrary.Forms.STButton();
            this.arrayLevelCounterLabel = new STLibrary.Forms.STLabel();
            this.BtmMipsLeft = new STLibrary.Forms.STButton();
            this.mipLevelCounterLabel = new STLibrary.Forms.STLabel();
            this.btnRightArray = new STLibrary.Forms.STButton();
            this.BtnMipsRight = new STLibrary.Forms.STButton();
            this.btnLeftArray = new STLibrary.Forms.STButton();
            this.imageBGComboBox = new STLibrary.Forms.STComboBox();
            this.stContextMenuStrip1 = new STLibrary.Forms.STMenuStrip();
        ...
        private STLibrary.Forms.STComboBox imageBGComboBox;
        private STLibrary.Forms.STButton BtnMipsRight;
        private STLibrary.Forms.STButton BtmMipsLeft;
        private STLibrary.Forms.STButton btnRightArray;
        private STLibrary.Forms.STButton btnLeftArray;
        private STLibrary.Forms.STLabel mipLevelCounterLabel;
        ...
        private STLibrary.Forms.STMenuStrip stContextMenuStrip1;
        ...
        private STLibrary.Forms.STButton editBtn;
        private System.Windows.Forms.ToolStripMenuItem generateMipmapsToolStripMenuItem;
        private STLibrary.Forms.STContextMenuStrip stContextMenuStrip2;
        ...
        private STLibrary.Forms.STButton alphaBtn;
        ...
        private STLibrary.Forms.STPanel stPanel5;
        private STLibrary.Forms.STLabel bottomLabel;
        ...
        private STLibrary.Forms.STContextMenuStrip stContextMenuStrip3;
